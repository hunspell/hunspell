...
class LocaleUtilsTest : public CppUnit::TestFixture {
    ...
    auto test_is_ascii() -> void {
        ...
        // Results in warning "multi-character character constant [-Wmultichar]"
...
//        CPPUNIT_ASSERT(true != is_ascii('Ӥ'));
    ...
    auto test_is_all_ascii() -> void
	{
        ...
        CPPUNIT_ASSERT(false == is_all_ascii(string("the brown foxĳӤ")));
    }
    ...
    auto test_latin1_to_ucs2() -> void
    {
        ...
        CPPUNIT_ASSERT(u"²¿ýþÿ" != latin1_to_ucs2(string("²¿ýþÿ"))); //QUESTION Is this OK?
    ...
    auto test_latin1_to_u32() -> void
    {
        ...
        CPPUNIT_ASSERT(U"²¿ýþÿ" != latin1_to_u32(string("²¿ýþÿ"))); //QUESTION Is this OK?
