...
alias hunspell='../../libtool --mode=execute ../../src/hunspell2/hun2'
...
if [ "$VALGRIND" != "" ]; then
  ...
  alias hunspell='../../libtool --mode=execute valgrind --tool=$VALGRIND --leak-check=yes --show-reachable=yes --log-file=$TEMPDIR/test.pid ../../src/hunspell2/hun2'
fi
